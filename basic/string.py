...
# Emoji
# print("U+1f647")   # replace + with three zeros 000
print("\U0001f647")


# String Concatination and int to string conversion
# print("Aryama"+str(10))
# print(10+int("as"))
...
user_second_name = input("Please provide me your second name:-->")
print("Your full name is: -->",user_first_name +" " + user_second_name)
